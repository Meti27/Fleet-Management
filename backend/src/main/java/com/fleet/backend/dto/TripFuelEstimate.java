 ...
 * consumption, adjusted for the payload the job is carrying.
 * Fields are null when the inputs are missing (too few pings, no
...
public record TripFuelEstimate(
        ...
        Double rateL100km,
        Double loadWeightTons,
        Double effectiveRateL100km,
